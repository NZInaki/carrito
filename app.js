...
const App = {
  data() {
    return {
      productos: [
        { id: 1, nombre: "Cartas", precio: 5, imagen: "img/cartas.jpeg", cantidadDeseada: 1 },
        { id: 2, nombre: "Golosinas", precio: 1, imagen: "img/golosinas.jpeg", cantidadDeseada: 1 },
        { id: 3, nombre: "Peluches", precio: 10, imagen: "img/peluches.jpg", cantidadDeseada: 1 },
        { id: 4, nombre: "Cojín", precio: 20, imagen: "img/cojin.jpeg", cantidadDeseada: 1 },
        { id: 5, nombre: "Chocolatinas", precio: 5, imagen: "img/chocolatinas.jpg", cantidadDeseada: 1 },
        { id: 6, nombre: "Más", precio: 50, imagen: "img/mas.png", cantidadDeseada: 1 },
      ],
      carrito: [],
      tasaCambio: 1,
